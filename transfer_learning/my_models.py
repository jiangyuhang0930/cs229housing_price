...
def get_random_forest(n_estimators = 100, max_depth = 100):
...
def get_mlp_regressor():
    return MLPRegressor(hidden_layer_sizes=(1024, 256), max_iter= 2000, verbose = 1, alpha=0.1, learning_rate="adaptive")
